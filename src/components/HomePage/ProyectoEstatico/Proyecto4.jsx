...
import img1 from '../../../../public/images/laravel-profesor/index-alumnos-show.jpg'
import img2 from '../../../../public/images/laravel-profesor/asistencias-alumnos.jpg'
import img3 from '../../../../public/images/laravel-profesor/notas-form-alumno.jpg'
        ...
        <div className="pt-20 m-4 text-start">
                ...
                <div >
                    ...
                    <div className="pt-4">
                        ...
                        <div className="inline-block">
                            <Link to="https://github.com/juanjoaquin/laravel-react-teacher" className=" font-montserrat pt-2 font-medium underline">Mirar repositorio de Github</Link>
                            <br />
            ...
            <div className="flex justify-center pt-10 lg:max-w-screen-lg lg:mx-auto">
                ...
                <div className="pt-4 space-y-8 flex flex-col ">
                    <img src={img1} className=" shadow-lg" alt="" />
                    <img src={img2} className=" shadow-lg" alt="" />
                    <img src={img3} className=" shadow-lg" alt="" />
                </div>
            </div>
            ...
            <div className="flex justify-center items-center  pt-4 text-center font-roboto font-semibold text-xl">
                <div className="flex gap-3 items-center ">
                    <div className=" flex items-center text-white bg-indigo-600 p-2 rounded-lg font-roboto hover:bg-indigo-800">
                        ...
                        <Link to="/proyectos/3">Anterior proyecto </Link>
                    </div>

                    <div className=" flex items-center text-white bg-indigo-600 p-2 rounded-lg font-roboto hover:bg-indigo-800">

                        <Link to="/proyectos/5"> Siguiente proyecto </Link>
                        <span class="material-symbols-outlined">
                            double_arrow
                        </span>
                    </div>
